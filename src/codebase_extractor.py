...
This script is designed to create a comprehensive snapshot of a software project,
facilitating the training of Large Language Models (LLMs) on codebases. It analyzes
a specified directory, generates detailed codemaps and extracting the codebase while
preserving its structure. The tool also examines and documents imported libraries,
providing insights into the project's dependencies.

Key features include:
- Interactive selection of directories, file types, and libraries to include
- Generation of hierarchical codemaps showing the project structure
- Extraction of the codebase with timestamps for each file
- Analysis and documentation of imported libraries, including versions and file counts
- Flexible output options for codemaps, codebases, and library information

By capturing the essence of a project's structure, contents, and dependencies,
this tool creates a rich dataset ideal for training LLMs to understand and work
